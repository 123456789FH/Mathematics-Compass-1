const CACHE='bousla-v4-membership';
const SHELL=['./','./index.html','./css/app.css','./js/config.js','./js/app.js','./js/demo-backend.js','./js/supabase-backend.js','./js/seed-data.js','./assets/images/logo.jpg','./assets/images/icon-192.png','./assets/images/icon-512.png','./manifest.webmanifest'];
